...
class OrganizadorTest {
	...
	void setUp() {
		// Arrange
		organizador = new Organizador(1L, "Amigos do bem", LocalDate.of(2024, 8, 10),"(15)99848885");
	}
	@Test
	...
	void testConstructorAll() {
		// Act
	Organizador novoOrganizador = new Organizador(3L, "Agencia do bem",LocalDate.of(2024, 9, 23),"15 99854885");
		// Assertion
